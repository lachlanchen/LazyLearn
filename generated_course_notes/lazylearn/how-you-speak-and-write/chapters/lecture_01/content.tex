...
\begin{equation}
\text{expert knowledge} \to \text{failure to model the audience} \to \text{jargon / acronyms / abstractions} \to \text{reader confusion}.
\end{equation}
...
&\not\Rightarrow \text{a stable scene for the reader}, \\
\text{``Kids look longer at a bunny than at a truck.''}
&\Rightarrow \text{an inspectable mental picture}.
\end{align}
